...
<body>
    <div class="flex flex-row font-customFont">
        ...
        <div id="main-content" class="font-customFont mx-5 mb-10 flex-grow transition-all duration-300">
            <div class="font-customFont font-bold my-5 text-2xl">
                <h1>RPL Konseling Individu</h1>
            </div>
            <div class="font-customFont font-medium size my-3 text-lg">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <form action="/rpl-konseling-individu/{{$i->id}}/delete" method="GET">
                            ...
                            <td class="px-6 py-4">
                                <form action="/rpl-konseling-individu/{{$i->id}}" method="GET">
                ...
                <dialog id="my_modal_4" class="modal">
                    <div class="modal-box w-fit  max-w-5xl">
                        ...
                        <form id="emailForm" action="/rpl-print/{{$i->id}}/pdfRplKonsulIndividu" method="GET">
                            @csrf
                            <div class="py-4">
                        ...
                        <div class="modal-box w-1/2 max-w-5xl">
                            ...
                            <form id="laporanKonselingIndividuForm" action="/rpl-konseling-individu/store-rpl-konseling-individu" method="POST">
                                ...
                                <div class="py-4">
                                    ...
                                    <input type="number" name="pertemuan_ke" id="kelas" class="border px-3 py-3 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                </div>
                                <div class="py-4">
