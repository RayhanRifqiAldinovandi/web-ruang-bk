...
<div class="container">
    ...
    <div class="flex-col">
        ...
        <div class="mb-2">
            <p>Berdasarkan sesi konseling ruang BK SMAN 3 Tarakan, berikut keterangan hasil konseling siswa A/N {{$data->nama_siswa}} <br>
               Deskripsi Pelanggaran: {{$data->deskripsi_pelanggaran}} <br>
               Layanan Yang Diberikan: {{$data->layanan}} <br>
               Tindak Lanjut: {{$data->tindak_lanjut}} <br>
               Keterangan: {{$data->keterangan}} <br></p>
        </div>
    </div>
